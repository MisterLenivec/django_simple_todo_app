...
class TestCheckMainPage:
    ...
    def test_comparison_of_the_number_of_tasks(self):
        self.page.task_count_on_page_should_be_equal_task_count_in_database()
    ...
    def test_create_task_on_page_equal_task_on_db(self):
        pass
    ...
    def test_task_is_correct(self):
        name, email = get_fake_name_and_email()
        self.page.create_task_with_title_and_description(name, email)
        self.page.should_be_correct_task_name_and_description(name, email)
